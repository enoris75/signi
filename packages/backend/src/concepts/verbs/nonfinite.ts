...
export const NONFINITE: Record<string, Record<string, Record<string, string>>> = {
  ...
  // B61's handling and leaving verbs. The transitive ones take HAVE; ottenuto, tenuto, messo, rivolto,
  // obtenu, mis and the German strong participles are irregular.
  GET: {
    en: { gerund: 'getting', participle: 'got' },
    it: { gerund: 'ottenendo', participle: 'ottenuto' },
    fr: { participle: 'obtenu' }, de: { participle: 'bekommen' },
    es: { gerund: 'consiguiendo', participle: 'conseguido' },
    pt: { gerund: 'conseguindo', participle: 'conseguido' },
    ja: { te: '手に入れて', te_reading: 'てにいれて', nai: '手に入れない', nai_reading: 'てにいれない', passive: '手に入れられる', passive_reading: 'てにいれられる' },
  },
  PUT: {
    en: { gerund: 'putting', participle: 'put' },
    it: { gerund: 'mettendo', participle: 'messo' },
    fr: { participle: 'mis' }, de: { participle: 'gelegt' },
    es: { gerund: 'poniendo', participle: 'puesto' },
    pt: { gerund: 'pondo', participle: 'posto' },
    ja: { te: '置いて', te_reading: 'おいて', nai: '置かない', nai_reading: 'おかない', passive: '置かれる', passive_reading: 'おかれる' },
  },
  KEEP: {
    en: { gerund: 'keeping', participle: 'kept' },
    it: { gerund: 'tenendo', participle: 'tenuto' },
    fr: { participle: 'gardé' }, de: { participle: 'behalten' },
  ...
  BRING: {
    ...
    it: { gerund: 'portando', participle: 'portato' },
    fr: { participle: 'apporté' }, de: { participle: 'gebracht' },
  ...
  LEAVE_BEHIND: {
    ...
    it: { gerund: 'lasciando', participle: 'lasciato' },
    fr: { participle: 'laissé' }, de: { participle: 'zurückgelassen' },
    es: { gerund: 'dejando', participle: 'dejado' },
    pt: { gerund: 'deixando', participle: 'deixado' },
    ja: { te: '置いていって', te_reading: 'おいていって', nai: '置いていかない', nai_reading: 'おいていかない', passive: '置いていかれる', passive_reading: 'おいていかれる' },
  },
  LOOK_AT: {
    en: { gerund: 'looking', participle: 'looked' },
    it: { gerund: 'guardando', participle: 'guardato' },
    fr: { participle: 'regardé' }, de: { participle: 'angesehen' },
    es: { gerund: 'mirando', participle: 'mirado' },
    pt: { gerund: 'olhando', participle: 'olhado' },
    ja: { te: '見て', te_reading: 'みて', nai: '見ない', nai_reading: 'みない', passive: '見られる', passive_reading: 'みられる' },
  },
  DIRECT_VERB: {
    en: { gerund: 'directing', participle: 'directed' },
    it: { gerund: 'rivolgendo', participle: 'rivolto' },
    fr: { participle: 'dirigé' }, de: { participle: 'gerichtet' },
    es: { gerund: 'dirigiendo', participle: 'dirigido' },
    pt: { gerund: 'dirigindo', participle: 'dirigido' },
    ja: { te: '向けて', te_reading: 'むけて', nai: '向けない', nai_reading: 'むけない', passive: '向けられる', passive_reading: 'むけられる' },
  },
  // The intransitive ones. Remaining and setting off select BE in it/fr/de (è restata, est partie, ist
  // geblieben); turning takes HAVE in it/fr (ha girato, a tourné), and the German reflexive haben
  // (hat sich gedreht), as every German reflexive does. The Spanish gerund carries quedarse's clitic.
  STAY: {
    en: { gerund: 'staying', participle: 'stayed' },
    it: { gerund: 'restando', participle: 'restato', aux: 'be' },
    fr: { participle: 'resté', aux: 'be' }, de: { participle: 'geblieben', aux: 'be' },
    es: { gerund: 'quedándose', participle: 'quedado' },
  ...
  TURN: {
    ...
    fr: { participle: 'tourné' }, de: { participle: 'gedreht' },
    es: { gerund: 'girando', participle: 'girado' },
    pt: { gerund: 'girando', participle: 'girado' },
    ja: { te: '回って', te_reading: 'まわって', nai: '回らない', nai_reading: 'まわらない' },
  },
  LEAVE_DEPART: {
    en: { gerund: 'leaving', participle: 'left' },
    it: { gerund: 'partendo', participle: 'partito', aux: 'be' },
    fr: { participle: 'parti', aux: 'be' }, de: { participle: 'weggegangen', aux: 'be' },
    es: { gerund: 'partiendo', participle: 'partido' },
  ...
  GO_OUT: {
    ...
    fr: { participle: 'sorti', aux: 'be' }, de: { participle: 'hinausgegangen', aux: 'be' },
