...
describe('the kin terms: a definite singular and plural in every language', () => {
  test.each<[string, Record<LanguageCode, string>, Record<LanguageCode, string>]>([
    ...
    ['MOM',
      { en: 'the mom.', it: 'la mamma.', fr: 'la maman.', de: 'die Mama.', es: 'la mamá.', ja: 'お母さん。', pt: 'a mamãe.' },
      { en: 'the moms.', it: 'le mamme.', fr: 'les mamans.', de: 'die Mamas.', es: 'las mamás.', ja: 'お母さん。', pt: 'as mamães.' }],
    ['DAD',
      { en: 'the dad.', it: 'il papà.', fr: 'le papa.', de: 'der Papa.', es: 'el papá.', ja: 'お父さん。', pt: 'o papai.' },
