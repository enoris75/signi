...
describe('the glosses the sweep shipped', () => {
  test.each<[string, Record<LanguageCode, string>]>([
    ...
    ['CANVAS', { en: 'a place where one makes phrases.', it: 'un luogo dove si fanno frasi.', fr: "un lieu où l'on fait des phrases.", de: 'ein Ort, in dem man Phrasen macht.', es: 'un lugar donde se hacen frases.', ja: 'フレーズを作る場所。', pt: 'um lugar onde se faz frases.' }],
