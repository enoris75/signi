...
describe('the adjectives on a feminine noun, attributive plural and predicate', () => {
  test.each<[string, Record<ReadyLanguageCode, string>, Record<ReadyLanguageCode, string>]>([
    ...
    ['DIFFERENT',
      { en: 'different houses collapse.', it: 'delle case diverse crollano.', fr: 'des maisons différentes s\'effondrent.',
    ...
    ['SURE',
      { en: 'sure houses collapse.', it: 'delle case sicure crollano.', fr: 'des maisons sûres s\'effondrent.', de: 'sichere Häuser kollabieren.',
    ...
    ['REAL_EXISTING',
      { en: 'real houses collapse.', it: 'delle case reali crollano.', fr: 'des maisons réelles s\'effondrent.', de: 'wirkliche Häuser kollabieren.',
    ...
    ['REAL_GENUINE',
      { en: 'real houses collapse.', it: 'delle vere case crollano.', fr: 'de vraies maisons s\'effondrent.', de: 'echte Häuser kollabieren.',
    ...
    ['IMPORTANT',
      { en: 'important houses collapse.', it: 'delle case importanti crollano.', fr: 'des maisons importantes s\'effondrent.',
    ...
    ['LONG',
      { en: 'long houses collapse.', it: 'delle case lunghe crollano.', fr: 'des maisons longues s\'effondrent.', de: 'lange Häuser kollabieren.',
    ...
    ['BLACK',
      { en: 'black houses collapse.', it: 'delle case nere crollano.', fr: 'des maisons noires s\'effondrent.', de: 'schwarze Häuser kollabieren.',
    ...
    ['WHITE',
      { en: 'white houses collapse.', it: 'delle case bianche crollano.', fr: 'des maisons blanches s\'effondrent.', de: 'weiße Häuser kollabieren.',
