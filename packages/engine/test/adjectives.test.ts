...
const EVERY_ADJECTIVE: [id: string, en: string][] = [
  ['ABLE', 'able'], ['ACTIVE', 'active'], ['ADDED', 'added'], ['ADULT', 'adult'], ['ADVERSATIVE', 'adversative'], ['APPROXIMATE', 'approximate'], ['BAD', 'bad'], ['BEAUTIFUL', 'beautiful'], ['BIG', 'big'],
  ['BLACK', 'black'], ['BROWN', 'brown'], ['CANINE', 'canine'], ['CAREFUL', 'careful'], ['CASTRATED', 'castrated'], ['CLOSED', 'closed'],
  ['COLD', 'cold'], ['COLD_CLIMATE', 'cold'], ['CONCLUSIVE', 'conclusive'], ['CONDITIONAL', 'conditional'], ['COORDINATED', 'coordinated'],
  ['COPIED', 'copied'], ['COPULATIVE', 'copulative'], ['DEFINITE', 'definite'], ['DIFFERENT', 'different'], ['DIRECT', 'direct'], ['DISJUNCTIVE', 'disjunctive'],
  ...
  ['QUICK', 'quick'], ['REAL_EXISTING', 'real'], ['REAL_GENUINE', 'real'], ['RECENT', 'recent'], ['REMOVED', 'removed'], ['RESULTATIVE', 'resultative'], ['ROUND', 'round'], ['SAD', 'sad'], ['SAVED', 'saved'],
  ['SECOND', 'second'], ['SEMANTIC', 'semantic'], ['SHARP', 'sharp'], ['SINGULAR', 'singular'], ['SMALL', 'small'], ['SOLE', 'sole'], ['SOLID', 'solid'],
  ['SPATIAL', 'spatial'], ['STRONG', 'strong'], ['SUBORDINATE', 'subordinate'], ['SURE', 'sure'], ['SWEET', 'sweet'], ['TEMPORAL', 'temporal'], ['THIRD', 'third'], ['TIDY', 'tidy'], ['TIRED', 'tired'], ['UNCONNECTED', 'unconnected'],
  ['UNEXPECTED', 'unexpected'], ['UNIVERSAL', 'universal'], ['UNKNOWN', 'unknown'], ['UNPINNED', 'unpinned'], ['UNTITLED', 'untitled'], ['VALID', 'valid'], ['VISIBLE', 'visible'], ['WARM', 'warm'], ['WEAK', 'weak'], ['WHITE', 'white'], ['WHOLE', 'whole'],
  ['WILD', 'wild'],
