...
const KANJI_NOUNS: [id: string, reading: string][] = [
  ...
  ['BUILDING', 'たてもの'], ['BUTCHER', 'にくや'], ['CASE_GRAMMAR', 'かく'], ['CAT', 'ねこ'], ['CAUSE', 'げんいん'], ['CHILD', 'こども'],
  ['COIN', 'こうか'],
  ['COMMAND', 'めいれい'], ['CONCEPT', 'がいねん'], ['CONTAINER', 'ようき'], ['CONTINENT', 'たいりく'],
  ['COW', 'うし'], ['CREATOR', 'そうぞうしゃ'], ['DEATH', 'し'], ['DEMONSTRATIVE', 'しじし'],
  ['DATIVE', 'よかく'], ['DETERMINER', 'げんていし'], ['DOG', 'いぬ'], ['ENGLISH', 'えいご'], ['FATHER', 'ちちおや'], ['FIRE', 'ひ'],
  ['FEELING', 'かんじょう'],
  ['GENDER', 'せい'], ['GENITIVE', 'ぞっかく'], ['HOME', 'いえ'], ['HOUSE', 'いえ'], ['INSTRUCTION', 'しじ'],
  ...
  ['SUBJECT_GRAMMAR', 'しゅご'], ['TEAR', 'なみだ'], ['TOOTH', 'は'], ['TRANSLATION', 'ほんやく'], ['VERB', 'どうし'], ['VOCATIVE', 'よびかけ'], ['WALL', 'かべ'], ['WATER', 'みず'],
