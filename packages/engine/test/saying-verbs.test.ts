...
// PENDING-L2-1 below, and German's accusative person is C35's), THINK with none.
...
// PENDING-L2-1. English renders every `terminus` with "to", so a verb whose addressee is a bare object
...
describe('known bugs: an English addressee that takes no "to" (PENDING-L2-1)', () => {
...
// PENDING-L2-2. The Italian imperfect subjunctive is built on the infinitive minus -re, with the
...
describe('known bugs: Italian dire in the imperfect subjunctive (PENDING-L2-2)', () => {
...
// PENDING-L2-3. A verb whose object takes a preposition (`object_prep`, A139) writes a pronoun object
...
describe('known bugs: the dative clitic of a prepositional object (PENDING-L2-3)', () => {
