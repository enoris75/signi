...
describe('what each console command is for', () => {
  const PURPOSES: Record<string, Record<string, string>> = {
    ...
    'purpose.interjection': {
      en: 'to add an interjection to a period.', it: "aggiungere un'interiezione a un periodo.",
    ...
    'purpose.contrast': {
      ...
      es: 'establecer la distancia de un determinante.', ja: '限定詞の距離を設定する。', pt: 'definir a distância de um determinante.',
    },
    'purpose.condition': {
