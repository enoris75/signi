...
// phrases whose head is their `subject`, serialized and hydrated the same way.
export const isNestedSelectionKey = (k: string): boolean => k.endsWith("Possessor") || k.endsWith("Standard");
