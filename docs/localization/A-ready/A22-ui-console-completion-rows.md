...
The `/…` rows' "also /x" and "now …" ([B46](../B-needs-seed/B46-ui-console-topics-and-labels.md)), "values
for /x" (B46), the echo icon's "from the canvas" ([B43](../B-needs-seed/B43-ui-canvas-preview-edit.md)) and
