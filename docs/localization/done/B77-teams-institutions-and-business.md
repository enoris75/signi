...
- **BUSINESS is proposed in its singular, mass words**, not the plurals the languages prefer for
  ...
  [P09-E41](../../features/Z-Done/P09-core-vocabulary/Z-done/P09-E41-pluralia-tantum.md), which also
...
1. **The plural business words** (*affari, affaires, negocios, negócios*) wait on
   [P09-E41](../../features/Z-Done/P09-core-vocabulary/Z-done/P09-E41-pluralia-tantum.md).
