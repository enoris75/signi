...
| `Degree: …` (caption) | [phraseRender.tsx:355](../../../packages/frontend/src/components/PhraseBuilder/phraseRender.tsx#L355) | `modifier.degree` | `nameOf('DEGREE')`; the values (More / Most / …) are [C13](../done/C13-ui-grammatical-function-words.md) |
