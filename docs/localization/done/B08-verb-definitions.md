...
| [B14](C17-motion-verbs-reflexive-genus.md) | MOVE | GO, RUN, COME, JUMP, COLLAPSE | ⚠ **owns the builder change** |
...
1. **The builder change is shared, not motion-specific.** B08 scoped it to motion verbs; it actually
   ...
   [B14](C17-motion-verbs-reflexive-genus.md) is the highest-leverage step in the split. (READ
