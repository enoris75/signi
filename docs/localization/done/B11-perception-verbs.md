...
and an unseeded EYE — the same builder gap as [B14](../B-needs-seed/B14-motion-verbs.md). LIGHT keeps it additive.
...
is **not** the complement change [B14](../B-needs-seed/B14-motion-verbs.md) owns, so BUY, B13 and
