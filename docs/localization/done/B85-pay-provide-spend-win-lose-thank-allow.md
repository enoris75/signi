...
[P09-E43](../../features/Z-Done/P09-core-vocabulary/Z-done/P09-E43-allow-to.md)'s; ALLOW is seeded here
...
2. **ALLOW + person + infinitive**, **HELP + infinitive** in Romance —
   [P09-E43](../../features/Z-Done/P09-core-vocabulary/Z-done/P09-E43-allow-to.md).
