...
_(split out of [B08](../done/B08-verb-definitions.md); filed as **C**, not B — seeding words does
not unblock these.)_
...
[B08's done half](../done/B08-verb-definitions.md) used to define EAT and DRINK; glossing it against
...
[B15](../done/B15-transfer-verbs.md) (SHOW) and [B19](../done/B19-data-verbs.md) (the nine app verbs
