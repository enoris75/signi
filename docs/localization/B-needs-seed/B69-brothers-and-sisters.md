...
## Probe renders (2026-09-22, engine source at HEAD in a detached worktree, lexicon seeded in memory with the forms above, PARENT carrying B68's D7 plurals)

| concept | en | it | fr | de | es | ja | pt |
|---|---|---|---|---|---|---|---|
| SIBLING | a person who has the same parents | una persona che ha gli stessi genitori | une personne qui a les mêmes parents | eine Person, die die gleichen Eltern hat | una persona que tiene **a** los mismos padres | 同じ親を持つ人 | uma pessoa que tem os mesmos pais |
| BROTHER | a male person who has the same parents | una persona maschile che ha gli stessi genitori | une personne masculine qui a les mêmes parents | eine männliche Person, die die gleichen Eltern hat | una persona masculina que tiene **a** los mismos padres | 同じ親を持つ男性の人 | uma pessoa masculina que tem os mesmos pais |
| SISTER | a female person who has the same parents | una persona femminile che ha gli stessi genitori | une personne féminine qui a les mêmes parents | eine weibliche Person, die die gleichen Eltern hat | una persona femenina que tiene **a** los mismos padres | 同じ親を持つ女性の人 | uma pessoa feminina que tem os mesmos pais |
...
1. **The genus route for BROTHER and SISTER**, kept for the record because D12 reasoned from it:
   ...
   child, so it fails the [C05](../done/C05-non-distinguishing-genera.md) test against
   CHILD_OFFSPRING.
