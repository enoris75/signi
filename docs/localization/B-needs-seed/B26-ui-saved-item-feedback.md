...
| Not a valid phrase file. · This file is not a Signi phrase file. · Phrase file is missing a version. · Phrase file has no workspace data. · That file isn't valid JSON. | [phraseSerialize.ts:243-287](../../../packages/frontend/src/components/PhraseBuilder/phraseSerialize.ts#L243-L287) | `toast.invalidFile` | `FILE this`, `verb: BE, negative`, `predicative: FILE indefinite [VALID], nounModifiers [PHRASE]` |
