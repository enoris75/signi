...
| C19 | [C19-verbs-needing-voice-purpose-or-comitative.md](C-needs-engine/C19-verbs-needing-voice-purpose-or-comitative.md) | the passive (BURN, and a ja CONSUME that fire can do), a similative complement (SEEM), a gloss worth the seed (BECOME), and C12's purpose clause / comitative / prior state (SAVE, ADD, TIDY_UP, LOAD) (split from C08) |
